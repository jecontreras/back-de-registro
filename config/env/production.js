  ...
  **************************************************************************/
  ...
  models: {
    ...
    ***************************************************************************/
    ...
    schema: true,
    dataEncryptionKeys: {
      default: 'BWVZ1lro80q7tXoW3OnP5F36Ytce81ixQP8Wddk5TWA='
    },
    attributes: {
  ...
  security: {
    ...
    ***************************************************************************/
    cors: {
      ...
      // allowOrigins: '*',
      allowOrigins: (function(){
        var hosts = [
          'https://www.lasmejoresfabricas.com',
          'https://dilisaplive.herokuapp.com',
          'https://tuventa.herokuapp.com',
        ];
        return hosts.join(',');
      })(),
